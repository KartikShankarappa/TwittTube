...
<body>
  ...
  <form   method="post" action="Login" class="login">
    <p>
      ...
      <input type="text" id="uname" name="Name" value="sugan">
    </p>

    <p>
      <label for="password">Password:</label>
      <input type="password" id="pwd" name="Pass" value="raj">
    </p>
    ...
    <p class="forgot-password"><a href="SignUp.jsp">Create account</a></p>
